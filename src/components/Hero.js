    ...
    >
      <div className='mx-auto flex flex-col justify-center h-full font-mono'>
        ...
        <p
          ...
          data-aos-delay='150'
          data-aos-once='true'
          className='text-emerald-600 py-6 max-w-[600px]'
        >
        ...
        <div className='w-full flex justify-start gap-4'>
          <button
            ...
            data-aos-delay='200'
            data-aos-once='true'
            className='px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-slate-200 font-bold mt-12 flex items-center space-x-3 font-mono rounded'
          >
          ...
          <a
            href='https://drive.google.com/file/d/1qAKcN1ZFaCC81SYeWEHylq610G9afCmZ/view?usp=share_link'
            className='px-8 py-4 bg-emerald-600 hover:bg-emerald-700 text-slate-200 font-bold mt-12 flex items-center space-x-3 font-mono rounded'
            target='_blank'
